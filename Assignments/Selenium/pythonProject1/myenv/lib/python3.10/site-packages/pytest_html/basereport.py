...
class BaseReport:
    ...
    def _run_count(self):
        ...
        if self._report.running_state == "finished":
            return f"{counts} {'q_tests' if plural else 'test'} took {duration}."

        return f"{counts}/{self._report.collected_items} {'q_tests' if plural else 'test'} done."
