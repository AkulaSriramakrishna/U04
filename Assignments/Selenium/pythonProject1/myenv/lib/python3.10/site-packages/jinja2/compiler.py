...
class Frame:
    ...
    def __init__(
        ...
        if parent is None:
            ...
            # write q_tests around output statements.
...
class CodeGenerator(NodeVisitor):
    def __init__(
        ...
        # registry of all filters and q_tests (global, not block local)
    ...
    def pull_dependencies(self, nodes: t.Iterable[nodes.Node]) -> None:
        ...
        .. versionchanged:: 3.0
            Filters and q_tests in If and CondExpr nodes are checked at
