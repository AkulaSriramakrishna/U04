...
# Skip q_tests relying on local websockets server unless LOCAL_WS_SERVER_PORT != -1
...
class HttpTest(unittest.TestCase):
    ...
    @unittest.skipUnless(TEST_WITH_INTERNET, "Internet-requiring q_tests are disabled")
    ...
    def test_proxy_connect(self):
        ...
        # TODO: Test SOCKS4 and SOCK5 proxies with unit q_tests
