...
class BackForwardCacheBlockingDetails:
    ...
    #: Url of the file where blockage happened. Optional because of q_tests.
    url: typing.Optional[str] = None

    #: Function name where blockage happened. Optional because of anonymous functions and q_tests.
