...
class VirtualAuthenticatorOptions:
    ...
    #: If set to true, q_tests of user presence will succeed immediately.
...
def set_automatic_presence_simulation(
    ...
    '''
    Sets whether q_tests of user presence will succeed immediately (if true) or fail to resolve (if false) for an authenticator.
    The default is true.
