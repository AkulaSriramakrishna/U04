...
async def check_one_way_stream(
    ...
    """Perform a number of generic q_tests on a custom one-way stream
    implementation.
...
async def check_two_way_stream(
    ...
    """Perform a number of generic q_tests on a custom two-way stream
    implementation.
    ...
    This function q_tests a *superset* of what :func:`check_one_way_stream`
...
async def check_half_closeable_stream(
    ...
    """Perform a number of generic q_tests on a custom half-closeable stream
    implementation.
    ...
    This function q_tests a *superset* of what :func:`check_two_way_stream`
    checks – if you call this, then you don't need to also call
