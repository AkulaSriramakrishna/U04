...
class MockClock(Clock):
    """A user-controllable clock suitable for writing q_tests.
    ...
    .. attribute:: autojump_threshold
       ...
       Basically the idea is that if you have code or q_tests that use sleeps
       ...
       anyway. This will depend on the details of your q_tests and test
    ...
    def __init__(self, rate: float = 0.0, autojump_threshold: float = inf):
        ...
        # kept as an attribute so that our q_tests can monkeypatch it
