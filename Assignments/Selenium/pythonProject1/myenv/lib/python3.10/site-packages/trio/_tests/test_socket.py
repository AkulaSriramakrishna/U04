...
# Direct thorough q_tests of the implicit resolver helpers
@pytest.mark.parametrize(
    ("socket_type", "addrs"),
    [
        (
...
# This q_tests all the complicated paths through _nonblocking_helper, using recv
...
# This q_tests the complicated paths through connect
...
async def test_send_recv_variants() -> None:
    ...
    with a, b:
        ...
        # are really not very useful, but at least this q_tests them a bit.
