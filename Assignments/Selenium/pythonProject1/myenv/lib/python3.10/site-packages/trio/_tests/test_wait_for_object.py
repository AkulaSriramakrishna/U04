...
# Mark all the q_tests in this file as being windows-only
...
async def test_WaitForMultipleObjects_sync() -> None:
    # This does a series of q_tests where we set/close the handle before
...
async def test_WaitForSingleObject_slow() -> None:
    ...
    # Set the timeout used in the q_tests. We test the waiting time against
